...
function loadpage() {
    ...
    $.jqPaginator('#pagination', {
        ...
        page: '<li class="page"><a onclick="selectHomeForm({{page}})">{{page}}</a></li>',
...
function firstBtn(pageNo){
    if(parseInt(pageNo) == 1){
        ...
        return '<li class="first"><a onclick="selectHomeForm(1)">首页</a></li>';
    }
}
function prevBtn(pageNo){
    if(parseInt(pageNo) == 1){
        ...
        return '<li class="prev"><a onclick="selectHomeForm(parseInt('+ pageNo + '- 1))"><i class="arrow arrow2"></i>上一页</a></li>';
    }
}
function nextBtn(pageNo, totalPage){
    if(parseInt(pageNo) == parseInt(totalPage)){
        ...
        return '<li class="next"><a onclick="selectHomeForm(parseInt('+ pageNo + '+ 1))">下一页<i class="arrow arrow3"></i></a></li>';
    }
}
function lastBtn(pageNo, totalPage){
    if(parseInt(pageNo) == parseInt(totalPage)){
        ...
        return '<li class="last"><a onclick="selectHomeForm('+ totalPage +')">末页</a></li>';
    }
}
// $(function () {
//     loadpage();
