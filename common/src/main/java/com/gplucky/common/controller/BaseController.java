...
public class BaseController {
    ...
    protected <T> ResponseEntity<String> returnSuccessMsg(PageG page, T t){
    ...
    private <T> ResponseEntity<String> returnMsg(String mark, String msg, PageG page, T t) {
        HttpResult<T> result = new HttpResult<T>();
        result.setMark(mark);
        result.setMessage(msg);
        result.setPageG(page);
        result.setData(t);
        return new ResponseEntity<String>(JSON.toJSONString(result), headers, HttpStatus.OK);
    }
}
